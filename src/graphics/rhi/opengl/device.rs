...
use crate::graphics::rhi::opengl::buffer::GlBuffer;
use crate::graphics::rhi::opengl::framebuffer::GlFramebuffer;
use crate::graphics::rhi::opengl::pipeline::GlPipeline;
use crate::graphics::rhi::opengl::shader::GlShader;
use crate::graphics::rhi::opengl::texture::GlTexture;
use crate::graphics::rhi::traits::*;
...
impl RhiDevice for GlDevice {
    ...
    fn submit(&mut self, cmds: &CommandBuffer) {
        ...
        for cmd in &cmds.commands {
            match cmd {
                crate::graphics::rhi::command_buffer::RenderCommand::ClearColor { r, g, b, a } => unsafe {
                    gl.clear_color(*r, *g, *b, *a);
                },
                crate::graphics::rhi::command_buffer::RenderCommand::ClearDepth { depth } => unsafe {
                    gl.clear_depth_f32(*depth);
                },
                crate::graphics::rhi::command_buffer::RenderCommand::SetViewport { x, y, w, h } => unsafe {
                    gl.viewport(*x, *y, *w, *h);
                },
                crate::graphics::rhi::command_buffer::RenderCommand::Draw {
                    vertices,
                    instances,
                } => unsafe {
                    if *instances > 1 {
                ...
                crate::graphics::rhi::command_buffer::RenderCommand::DrawIndexed {
                    indices,
                    instances,
                } => unsafe {
                    if *instances > 1 {
